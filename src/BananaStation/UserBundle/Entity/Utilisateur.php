 ...
 * @ORM\Entity(repositoryClass="BananaStation\UserBundle\Entity\Repository\UtilisateurRepository")
 */
class Utilisateur implements UserInterface {
    ...
    /**
     * @ORM\OneToMany(targetEntity="BananaStation\CoreBundle\Entity\Commentaire", mappedBy="utilisateur", cascade={"persist", "remove"})
     */
    private $commentaires;

    /**
     * @ORM\OneToMany(targetEntity="BananaStation\CoreBundle\Entity\Avis", mappedBy="utilisateur", cascade={"persist", "remove"})
     */
    private $avis;
